...
export const ServiceCard: React.FC<ServiceCardProps> = ({ title, description }): JSX.Element => {
    ...
    return (
        <Card>
            <Card.CardWrapper styles={'bg-white bg-leaf-bg bg-no-repeat bg-right-bottom w-[350px]  flex justify-center items-center flex-col rounded-md h-[150px] shadow-penumbra'}>
