...
import AgricProductCard from "@/components/shared/AgricProductCard"
...
export default function SingleProductList() {
    ...
    const product = AGRIC_PRODUCTS.find((item) => item.name === name)
        ...
        <FlexContainer tag={"div"} styles="justify-between flex-wrap gap-10 lg:gap-4 pb-[100px] lg:pb-[50px]">
            ...
            <FlexContainer tag="div" styles="basis-[55%] lg:basis-[100%] flex-col order-4 lg:order-3">
                <Fade direction="up" duration={1000}>
                    <Typography variant="h1" children={product?.name} styles="text-5xl lg:text-4xl mb-4 font-bold font-roboto-serif" />
                </Fade>
